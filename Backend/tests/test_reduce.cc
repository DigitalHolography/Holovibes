...
TEST(ReduceTest, RegularTest)
{
    ...
    test_gpu_reduce_add(d_result, d_data, image_width * image_height);
...
TEST(ReduceTest, Test_min_1024x1024)
{
    ...
    test_gpu_reduce_min(d_result, d_data, image_width * image_height);
    cudaXStreamSynchronize(stream);
...
TEST(ReduceTest, Test_int_max_1024x1024)
{
    ...
    test_gpu_reduce_max(d_result, d_data, image_width * image_height);
    cudaXStreamSynchronize(stream);
