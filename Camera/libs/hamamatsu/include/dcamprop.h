...
#define DCAM_DEFAULT_ARG
    ...
    typedef enum _DCAMPROPATTRIBUTE
    {
        ...
        DCAMPROP_ATTR_AUTOROUNDING =
            0x00800000, /* The dcam_setproperty() or dcam_setgetproperty() will failure if this bit exists. */
        ...
        DCAMPROP_ATTR__SYSTEM = 0x00004000,
        /* system id								*/ /* reserved */
        ...
        DCAMPROP_ATTR_ADVANCED = 0x00000800,
        /* User has to take care to change this value */ /* reserved */
        DCAMPROP_ATTR_ACTION = 0x00000400,
        /* writing value takes related effect		*/ /* reserved */
        DCAMPROP_ATTR_EFFECTIVE = 0x00000200,
        /* value is effective						*/ /* reserved */
    ...
    typedef enum _DCAMPROPMODEVALUE
    {
        ...
        /*	"PROGRESSIVE"			*/ /* reserved */
        DCAMPROP_SENSORMODE__SPLITVIEW = 14,
        /*	"SPLIT VIEW"			*/ /* reserved */
        ...
        /* DCAM_IDPROP_CONTRAST_CONTROL */                 /* reserved */
                                                           /*	DCAMPROP_CONTRAST_CONTROL__OFF				= 1,	*/
        /*	"OFF"					*/ /* reserved */
                                                           /*	DCAMPROP_CONTRAST_CONTROL__ON				= 2,	*/
        /*	"ON"					*/ /* reserved */
        /*	DCAMPROP_CONTRAST_CONTROL__FRONTPANEL		= 3,	*/
        /*	"FRONT PANEL"			*/ /* reserved
                                                    */
        ...
        /*	"BACK FOCUS CALIBRATION"*/ /* ORCA-D2 */
    ...
    typedef enum _DCAMIDPROP
    {
        ...
        DCAM_IDPROP_SENSITIVITY2_MODE = 0x00200230,
        /* R/W, mode,	"SENSITIVITY2 MODE"		*/ /* reserved */
        ...
        DCAM_IDPROP_MECHANICALSHUTTER = 0x00200410,        /* R/W, mode,	"MECHANICAL SHUTTER"	*/
                                                           /*	DCAM_IDPROP_MECHANICALSHUTTER_AUTOMODE		= 0x00200420,*/
        /* R/W, mode,	"MECHANICAL SHUTTER AUTOMODE"	*/ /* reserved */

        /* contrast enhance */
        /*	DCAM_IDPROP_CONTRAST_CONTROL				= 0x00300110,*/
        /* R/W, mode,	"CONTRAST CONTROL"		*/ /* reserved */
        ...
        /* color features */
        DCAM_IDPROP_VIVIDCOLOR = 0x00300200,
        /* R/W, mode,	"VIVID COLOR"			*/ /* comment */
        ...
        DCAM_IDPROP_SENSORMODE_SLITHEIGHT = 0x00400220,
        /* R/W, long,	"SENSOR MODE SLIT HEIGHT"		*/ /* reserved */
        DCAM_IDPROP_SENSORMODE_LINEBUNDLEHEIGHT = 0x00400250,      /* R/W, long,	"SENSOR MODE LINE BUNDLEHEIGHT"	*/
        DCAM_IDPROP_SENSORMODE_FRAMINGHEIGHT = 0x00400260,
        /* R/W, long,	"SENSOR MODE FRAMING HEIGHT"	*/   /* reserved */
        ...
        DCAM_IDPROP_OUTPUTDATA_ORIENTATION = 0x00400420,
        /* R/W, mode,	"OUTPUT DATA ORIENTATION"	*/ /* reserved */
        DCAM_IDPROP_OUTPUTDATA_ROTATION = 0x00400430,
        /* R/W, degree,	"OUTPUT DATA ROTATION"		*/ /* reserved */
        ...
        DCAM_IDPROP_IMAGE_TOPOFFSETBYTES = 0x00420250,
        /* R/O, long,	"IMAGE TOP OFFSET BYTES"*/  /* reserved */
        ...
        DCAM_IDPROP_IMAGEDETECTOR_PIXELWIDTH = 0x00420810,
        /* R/O, micro-meter, "IMAGE DETECTOR PIXEL WIDTH"	*/ /* reserved */
        DCAM_IDPROP_IMAGEDETECTOR_PIXELHEIGHT = 0x00420820,
        /* R/O, micro-meter, "IMAGE DETECTOR PIXEL HEIGHT"	*/ /* reserved */
