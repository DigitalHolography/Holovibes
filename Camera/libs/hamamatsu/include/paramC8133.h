...
struct DCAM_PARAM_C8133
{
    ...
    int pixelCount, pixelSize, outClock;

    int lsMode;
    double lsData;
    int bsDark, bsBright, jsDatCount, jsRate, jsAveCount, esCount, esLeft[C8133_kESCount_Max],
        esRight[C8133_kESCount_Max], cmMode, cmData, bmMode, voMode, toMode, aiTableNo;
    int sr;
    int scrollLine;
    int reserve;
};
