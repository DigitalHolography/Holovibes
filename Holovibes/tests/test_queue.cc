...
{
    camera::FrameDescriptor fd = {64, 64, PixelDepth::Bits8, camera::Endianness::BigEndian};
...
// {
//     camera::FrameDescriptor fd = {4, 4, PixelDepth::Bits8, camera::Endianness::BigEndian};
...
{
    camera::FrameDescriptor fd = {1, 1, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q(fd, 2, holovibes::QueueType::UNDEFINED);
...
{
    camera::FrameDescriptor fd = {56, 17, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q(fd, 2, holovibes::QueueType::UNDEFINED);
    ASSERT_EQ(q.get_size(), 0);
...
TEST(MultipleEnqueueOddSize, QueueMultipleEnqueue)
{
    ...
    holovibes::Queue q(fd, queue_size, holovibes::QueueType::UNDEFINED);
...
TEST(MultipleEnqueueNonSquare, QueueMultipleEnqueue)
{
    ...
    camera::FrameDescriptor fd = {3, 1, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q(fd, 2, holovibes::QueueType::UNDEFINED);
...
{
    camera::FrameDescriptor fd = {64, 64, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q(fd, 3, holovibes::QueueType::UNDEFINED);
...
TEST(SimpleDequeueValue, QueueDequeueValue)
{
    ...
    char* buff[] = {_strdup("ab\0"), _strdup("cd\0"), _strdup("ef\0")};
...
{
    camera::FrameDescriptor fd = {4, 4, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q_src(fd, 2, holovibes::QueueType::UNDEFINED);
    holovibes::Queue q_dst(fd, 4, holovibes::QueueType::UNDEFINED);
...
TEST(MoreElementCopyMultiple, QueueCopyMultiple)
{
    ...
    camera::FrameDescriptor fd = {3, 1, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q_src(fd, 2, holovibes::QueueType::UNDEFINED);
    holovibes::Queue q_dst(fd, 3, holovibes::QueueType::UNDEFINED);
...
{
    camera::FrameDescriptor fd = {3, 1, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q_src(fd, 4, holovibes::QueueType::UNDEFINED);
    holovibes::Queue q_dst(fd, 3, holovibes::QueueType::UNDEFINED);
...
{
    camera::FrameDescriptor fd = {3, 1, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q_src(fd, 3, holovibes::QueueType::UNDEFINED);
    holovibes::Queue q_dst(fd, 3, holovibes::QueueType::UNDEFINED);
...
{
    camera::FrameDescriptor fd = {2, 1, PixelDepth::Bits8, camera::Endianness::BigEndian};
    holovibes::Queue q_src(fd, 11, holovibes::QueueType::UNDEFINED);
    holovibes::Queue q_dst(fd, 3, holovibes::QueueType::UNDEFINED);

    // 11 + 3 = 14 characters
    char* new_elt = _strdup("a\0b\0c\0d\0e\0f\0g\0h\0i\0j\0k\0l\0m\0n\0");
