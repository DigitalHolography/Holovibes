...
/*! \namespace ui
 * \brief Generated by Qt
 */

/*! \brief Containt all function adding graphical interface to project */
namespace gui
{
  /*! \brief MainWindow
  **
  ...
  */
  ...
  public:
    ...
    */
    MainWindow(holovibes::Holovibes& holovibes, QWidget *parent = nullptr);
    ...
    */
    void set_algorithm(const QString value);
    /*! \} */ // End of group Image rendering
    ...
    */
    ...
    /*! \brief Request autofocus action in pipe
  ...
  private:
    ...
    */
    ...
    void global_visibility(const bool value);

    void camera_visible(const bool value);

    void contrast_visible(const bool value);

    void record_visible(const bool value);

    void record_but_cancel_visible(const bool value);

    void image_ratio_visible(const bool value);

    void average_visible(const bool value);

    void average_record_but_cancel_visible(const bool value);
    /*! \} */ // End of group Visibility
    ...
    */
    void change_camera(const holovibes::Holovibes::camera_type camera_type);
    ...
    */
    void display_info(const std::string msg);
    ...
    */
    void split_string(const std::string& str, const char delim, std::vector<std::string>& elts);
    ...
    */
    std::string format_batch_output(const std::string& path, const unsigned int index);
