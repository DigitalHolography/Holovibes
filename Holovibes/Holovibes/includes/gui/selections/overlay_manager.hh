...
class OverlayManager
{
  public:
    ...
    void create_overlay();
    /*! \brief Create the default overlay in the view. Zoom for Raw/Holo, Cross
     * for Slices. */
    void create_default();
    ...
    /*! \brief Disable all the overlays. If def is set, it will create a default
     * overlay. */
  ...
  private:
    //! Push in the vector the newly created overlay, set the current overlay,
    ...
    /*! \brief Try to set the current overlay to the first active overlay of a
     * given type. */
