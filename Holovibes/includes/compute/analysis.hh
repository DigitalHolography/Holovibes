...
class Analysis
{
  public:
        ...
        , realtime_settings_(settings)
    {
        ...
        float* data_csv_cpu = load_CSV_to_float_array("C:/Users/Domodekavkaz/Documents/Holovibes/tests_csv/data_n.csv");
        ...
        data_csv_cpu = load_CSV_to_float_array("C:/Users/Domodekavkaz/Documents/Holovibes/tests_csv/f_AVG_mean.csv");
        f_avg_csv_.resize(frame_res);
        cudaXMemcpy(f_avg_csv_, data_csv_cpu, frame_res * sizeof(float), cudaMemcpyHostToDevice);
        cudaXStreamSynchronize(stream_);
        delete[] data_csv_cpu;

        data_csv_cpu = load_CSV_to_float_array("C:/Users/Domodekavkaz/Documents/Holovibes/tests_csv/vascularPulse.csv");
        ...
        data_csv_cpu =
            load_CSV_to_float_array("C:/Users/Domodekavkaz/Documents/Holovibes/tests_csv/R_VascularPulse.csv");
