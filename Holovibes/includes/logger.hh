/*! \file
 *
 * \brief Logger that can be used in debug mode (ifdef _DEBUG) or in release else
 */
#pragma once
...
/*!
 * \brief log functions are used to access compilation data like __FILE__, __LINE__, __FUNCTION__
 */
