...
namespace holovibes
{
	namespace gui
	{
		...
		private:
			...
			GLuint	create_gl_buffer(GLuint *gl_buffer, const void *data, size_t nb_vertex, size_t elts_per_vec);
			void	load_matrix(glm::vec3 Translate, glm::vec3 const & Rotate, float scale);
