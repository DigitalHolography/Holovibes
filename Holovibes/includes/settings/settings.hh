...
DECLARE_SETTING(ImageInterpolationOutputEnabled, bool);
DECLARE_SETTING(ImageInterpolationOutputX, unsigned);
DECLARE_SETTING(ImageInterpolationOutputY, unsigned);
