...
class InformationContainer
{
  ...
  private:
    /*! \brief Give access to protected members to the InformationWorker */
    friend class worker::InformationWorker;

    /*! \brief The mutex used to prevent data races */
    ...
    /*! \brief The map associating a fps type with its corresponding value */
