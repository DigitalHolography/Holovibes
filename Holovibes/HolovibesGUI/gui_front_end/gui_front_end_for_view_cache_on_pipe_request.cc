...
void GuiFrontEndForViewCacheOnPipeRequest::before_method<ChartDisplayEnabled>()
{
    ...
    UserInterface::instance().main_window->synchronize_thread(
        []() { UserInterface::instance().plot_window_.reset(nullptr); }, true);
}
...
template <>
void GuiFrontEndForViewCacheOnPipeRequest::before_method<CutsViewEnable>()
{
    LOG_UPDATE_FRONT_END_BEFORE(CutsViewEnable);

    if (api::detail::get_value<CutsViewEnable>())
        return;
...
template <>
void GuiFrontEndForViewCacheOnPipeRequest::after_method<CutsViewEnable>()
{
    LOG_UPDATE_FRONT_END_AFTER(CutsViewEnable);

    if (api::detail::get_value<CutsViewEnable>() == false)
        return;
...
void GuiFrontEndForViewCacheOnPipeRequest::before_method<Reticle>()
{
    ...
    UserInterface::instance().main_window->synchronize_thread(
        [=]() { UserInterface::instance().xy_window->getOverlayManager().disable_all(gui::KindOfOverlay::Reticle); }, true);
}
...
void GuiFrontEndForViewCacheOnPipeRequest::before_method<LensViewEnabled>()
{
    ...
    UserInterface::instance().main_window->synchronize_thread(
        []() { UserInterface::instance().lens_window.reset(nullptr); }, true);
}
...
void GuiFrontEndForViewCacheOnPipeRequest::before_method<RawViewEnabled>()
{
    ...
    UserInterface::instance().main_window->synchronize_thread([]()
                                                              { UserInterface::instance().raw_window.reset(nullptr); }, true);
}
...
void GuiFrontEndForViewCacheOnPipeRequest::before_method<Filter2DViewEnabled>()
{
    ...
    UserInterface::instance().main_window->synchronize_thread(
        []() { UserInterface::instance().filter2d_window.reset(nullptr); }, true);
}
