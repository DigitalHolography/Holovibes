...
void save_ini(boost::property_tree::ptree& ptree, const ComputeDescriptor& cd)
{
    ...
    ptree.put<int>("image_rendering.filter2d_n1",
                   static_cast<int>(cd.filter2d_n1.load()));
    ptree.put<int>("image_rendering.filter2d_n2",
                   static_cast<int>(cd.filter2d_n2.load()));
