...
//     compute_cache_.set_time_transformation_stride(ptree.get<ushort>("image_rendering.time_transformation_stride",
//     1)); compute_cache_.set_space_transformation(static_cast<SpaceTransformation>(
...
// {
//     view.log_scale_slice_enabled = ptree.get<bool>("view." + name + "_log_scale_enabled",
//     view.log_scale_slice_enabled);

//     view.contrast_enabled = ptree.get<bool>("view." + name + "_contrast_enabled", view.contrast_enabled);
//     view.contrast_auto_refresh = ptree.get<bool>("view." + name + "_auto_contrast_enabled",
//     view.contrast_auto_refresh); view.contrast_invert = ptree.get<bool>("view." + name + "_invert_enabled",
//     view.contrast_invert); view.contrast_min = ptree.get<float>("view." + name + "_contrast_min", view.contrast_min);
...
// //     view_cache_.set_x(View_XY{View_Accu{ptree.get<short>("view.x_accu", 0)}, ptree.get<ushort>("view.x_cuts",
// 0)});
// //     view_cache_.set_y(View_XY{View_Accu{ptree.get<short>("view.y_accu", 0)}, ptree.get<ushort>("view.y_cuts",
// 0)});
...
//     static_cast<int>(compute_cache_.get_space_transformation()));
//     ptree.put<int>("image_rendering.time_transformation",
//     static_cast<int>(compute_cache_.get_time_transformation())); ptree.put<float>("image_rendering.lambda",
//     compute_cache_.get_lambda()); ptree.put<float>("image_rendering.z_distance", compute_cache_.get_z_distance());
