...
void Views::Update()
{
    this->image_type = GSH::instance().get_value<ImageType>();
    ...
    this->z = GSH::instance().get_value<ViewAccuP>();
    this->z2 = GSH::instance().get_value<ViewAccuQ>();
    this->window.Update();
...
void Rendering::Update()
{
    ...
    this->propagation_distance = GSH::instance().get_value<ZDistance>();
...
void Composite::Update()
{
    ...
    this->auto_weight = GSH::instance().get_value<CompositeAutoWeights>();
...
void Composite::Load()
{
    ...
    GSH::instance().set_value<CompositeAutoWeights>(this->auto_weight);
...
void Views::Load()
{
    GSH::instance().set_value<ImageType>(this->image_type);
    ...
    GSH::instance().set_value<ViewAccuP>(this->z);
    GSH::instance().set_value<ViewAccuQ>(this->z2);
    this->window.Load();
...
void Rendering::Load()
{
    ...
    GSH::instance().set_value<ZDistance>(this->propagation_distance);
