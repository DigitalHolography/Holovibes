...
{
    Logger::api().trace("set_record_mode : {}", text);
...
{
    Logger::api().trace("import_start file:{} ; fps:{} ; first_frame:{} ; last_frame:{} ; load_file_in_gpu:{}",
                        file_path,
                        fps,
                        first_frame,
                        last_frame,
