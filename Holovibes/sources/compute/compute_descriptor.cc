...
namespace holovibes
{
	...
	ComputeDescriptor::ComputeDescriptor() : Observable(),
		...
		pre_fft_shift_enabled(false),
		post_fft_shift_enabled(false),
	...
	ComputeDescriptor& ComputeDescriptor::operator=(const ComputeDescriptor& cd)
	{
		...
		pre_fft_shift_enabled = cd.pre_fft_shift_enabled.load();
		post_fft_shift_enabled = cd.post_fft_shift_enabled.load();
