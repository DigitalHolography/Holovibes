...
void create_holo_window(ushort window_size)
{
    ...
    try
    {
        ...
        UserInterfaceDescriptor::instance().mainDisplay->setAngle(api::get_current_view_as_view_xyz().rot);
        UserInterfaceDescriptor::instance().mainDisplay->setFlip(api::get_current_view_as_view_xyz().flip_enabled);
    }
