...
void LightUI::camera_ametek_s980_coaxlink_qspf_plus() { change_camera(CameraKind::AmetekS980EuresysCoaxlinkQSFP); }
...
{
    std::filesystem::path dest = __PRESET_FOLDER_PATH__ / "doppler_8b_384_384_37.json";
