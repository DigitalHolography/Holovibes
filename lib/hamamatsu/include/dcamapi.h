...
DCAM_DECLARE_BEGIN( enum, DCAMERR )
{
  ...
  /* calling error */
	...
	DCAMERR_NEWAPIREQUIRED		= 0x80000826,/*		old API does not support the value because only new API supports the value */
	...
	DCAMERR_INVALIDSUBARRAY		= 0x8000082b,/*		the conbination of subarray values are invalid. e.g. DCAM_IDPROP_SUBARRAYHPOS + DCAM_IDPROP_SUBARRAYHSIZE is greater than the number of horizontal pixel of sensor. */
