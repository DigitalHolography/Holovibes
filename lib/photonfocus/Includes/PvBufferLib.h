...
#define __PVBUFFERLIB_H__
    ...
    #pragma comment( lib, "PvBuffer" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // PV_BUFFER_EXPORTS


#endif // __PVBUFFERLIB_H__
