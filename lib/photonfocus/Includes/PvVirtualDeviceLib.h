...
#ifndef __PV_VIRTUAL_DEVICELIB_H__
#define __PV_VIRTUAL_DEVICELIB_H__

#ifdef PV_VIRTUAL_DEVICE_EXPORTS
...
#else // PV_VIRTUAL_DEVICE_EXPORTS
    ...
    #pragma comment( lib, "PvVirtualDevice" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // PV_VIRTUAL_DEVICE_EXPORTS
...
#endif // __PV_VIRTUAL_DEVICELIB_H__
