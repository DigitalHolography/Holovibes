...
// *****************************************************************************
//
// File Name....: PvGUIUtilsLib.h
//
// *****************************************************************************

#ifndef __PVGUIUTILSLIB_H__
#define __PVGUIUTILSLIB_H__


#ifdef PV_GUIUTILS_EXPORTS

    // Define the export symbol
	#if !defined(PT_LIB_STATIC) && defined(WIN32)
		#define PV_GUIUTILS_API __declspec( dllexport )
	#else
		#define PV_GUIUTILS_API
	#endif // PT_LIB_STATIC

#else // PV_GUIUTILS_EXPORTS

    // Define the import symbol
	#if !defined(PT_LIB_STATIC) && defined(WIN32)
		#define PV_GUIUTILS_API __declspec( dllimport )
	#else
		#define PV_GUIUTILS_API
	#endif // PT_LIB_STATIC
    ...
    #pragma comment( lib, "PvGUIUtils" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // PV_GUIUTILS_EXPORTS


#endif // __PVGUIUTILSLIB_H__
