...
#define __PTUTILS_LIB_H__
		...
		// Define the suffix used for the static version of the library file
				...
				#define PT_SUFFIX_STATIC "s_"
			#else
				#define PT_SUFFIX_STATIC "s"
			#endif // #if defined( _PT_DEBUG_ ) && defined( PT_DEBUG_ENABLED )
		#else // PT_LIB_STATIC
		...
		#pragma comment( lib, "PtUtilsLib" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
