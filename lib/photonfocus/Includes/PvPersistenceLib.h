...
#define __PVPERSISTENCELIB_H__
    ...
    #pragma comment( lib, "PvPersistence" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // PV_PERSISTENCE_EXPORTS


#endif // __PVPERSISTENCELIB_H__
