...
#define DCAMCONST_FRAMESTAMP_MISMATCH 0xFFFFFFFF
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMERR){
        ...
        DCAMERR_INVALIDSUBARRAY =
            0x8000082b, /*		the combination of subarray values are invalid. e.g. DCAM_IDPROP_SUBARRAYHPOS +
        ...
        DCAMERR_APIINIT_INITOPTIONBYTES =
            0xa4010003,                          /*	"API_INIT has a invalid parameter is initoptionbytes!"	*/
        ...
        DCAM_DECLARE_BEGIN(enum,
                           DCAMBUF_FRAME_OPTION){DCAMBUF_FRAME_OPTION__VIEW_ALL = 0x00000000,
                                                 ...
                                                 end_of_dcambuf_frame_option} DCAM_DECLARE_END(DCAMBUF_FRAME_OPTION)
            ...
            DCAM_DECLARE_BEGIN(enum,
                               DCAMREC_FRAME_OPTION){DCAMREC_FRAME_OPTION__VIEW_CURRENT = 0x00000000,
                                                     ...
                                                     endof_dcamrec_frame_option} DCAM_DECLARE_END(DCAMREC_FRAME_OPTION)
                ...
                DCAM_DECLARE_BEGIN(enum, DCAMBUF_METADATAOPTION){
                    ...
                    DCAMBUF_METADATAOPTION__VIEW__MASK =
                        DCAMBUF_FRAME_OPTION__VIEW__MASK} DCAM_DECLARE_END(DCAMBUF_METADATAOPTION)
                    ...
                    DCAM_DECLARE_BEGIN(enum, DCAMREC_METADATAOPTION){
                        ...
                        DCAMREC_METADATAOPTION__LOCATION__MASK = 0xFF000000} DCAM_DECLARE_END(DCAMREC_METADATAOPTION)
                        ...
                        DCAM_DECLARE_BEGIN(enum, DCAM_PIXELTYPE){
                            ...
                            DCAM_DECLARE_BEGIN(enum, DCAMBUF_ATTACHKIND){
                                ...
                                DCAM_DECLARE_BEGIN(enum, DCAMCAP_TRANSFERKIND){
                                    DCAMCAP_TRANSFERKIND_FRAME = 0} DCAM_DECLARE_END(DCAMCAP_TRANSFERKIND)

        /*** --- status --- ***/
        DCAM_DECLARE_BEGIN(enum, DCAMCAP_STATUS){DCAMCAP_STATUS_ERROR = 0x0000,
                                                 DCAMCAP_STATUS_BUSY = 0x0001,
                                                 DCAMCAP_STATUS_READY = 0x0002,
                                                 DCAMCAP_STATUS_STABLE = 0x0003,
                                                 DCAMCAP_STATUS_UNSTABLE = 0x0004,

                                                 end_of_dcamcap_status} DCAM_DECLARE_END(DCAMCAP_STATUS)

            DCAM_DECLARE_BEGIN(enum,
                               DCAMWAIT_EVENT){DCAMWAIT_CAPEVENT_TRANSFERRED = 0x0001,
                                               ...
                                               end_of_dcamwait_event} DCAM_DECLARE_END(DCAMWAIT_EVENT)
        ...
        /*** --- wait timeout --- ***/
        DCAM_DECLARE_BEGIN(enum, DCAMWAIT_TIMEOUT){DCAMWAIT_TIMEOUT_INFINITE = 0x80000000,

                                                   end_of_dcamwait_timeout} DCAM_DECLARE_END(DCAMWAIT_TIMEOUT)
        ...
        DCAM_DECLARE_BEGIN(enum, DCAMDATA_KIND){DCAMDATA_KIND__REGION = 0x00000001,
                                                DCAMDATA_KIND__LUT = 0x00000002,
                                                DCAMDATA_KIND__NONE = 0x00000000} DCAM_DECLARE_END(DCAMDATA_KIND)
        ...
        DCAM_DECLARE_BEGIN(enum, DCAMDATA_REGIONTYPE){
            ...
            DCAMDATA_REGIONTYPE__NONE = 0x00000000} DCAM_DECLARE_END(DCAMDATA_REGIONTYPE)
        ...
        DCAM_DECLARE_BEGIN(enum,
                           DCAMDATA_LUTTYPE){DCAMDATA_LUTTYPE__SEGMENTED_LINEAR = 0x00000001,
                                             ...
                                             DCAMDATA_LUTTYPE__NONE = 0x00000000} DCAM_DECLARE_END(DCAMDATA_LUTTYPE)

        /*** --- DCAMBUF proc type --- ***/
        DCAM_DECLARE_BEGIN(enum, DCAMBUF_PROCTYPE){
            DCAMBUF_PROCTYPE__HIGHCONTRASTMODE = DCAMBUF_FRAME_OPTION__PROC_HIGHCONTRAST,

            DCAMBUF_PROCTYPE__NONE = 0x00000000} DCAM_DECLARE_END(DCAMBUF_PROCTYPE)
        ...
        DCAM_DECLARE_BEGIN(enum, DCAMDEV_CAPDOMAIN){
            ...
            DCAMDEV_CAPDOMAIN__FUNCTION = 0x00000000} DCAM_DECLARE_END(DCAMDEV_CAPDOMAIN)
            ...
            DCAM_DECLARE_BEGIN(enum,
                               DCAMDEV_CAPFLAG){DCAMDEV_CAPFLAG_FRAMESTAMP = 0x00000001,
                                                ...
                                                DCAMDEV_CAPFLAG_NONE = 0x00000000} DCAM_DECLARE_END(DCAMDEV_CAPFLAG)
    ...
    DCAM_DECLARE_BEGIN(struct, DCAMDEV_CAPABILITY_FRAMEOPTION)
    {
        ...
        int32 supportproc; // [out] support DCAMBUF_PROCTYPE__* flags in the camera. hdr.capflag may be 0 if the
                           // function doesn't work in current condition.
    }
