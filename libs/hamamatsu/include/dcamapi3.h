...
#endif // ! defined( DCAM_TARGETOS_IS_WIN32 ) && ! defined( DCAM_TARGETOS_IS_MACOSX ) && ! defined( DCAM_TARGETOS_IS_LINUX )
...
enum {
	 DCAM_IDMSG_QUERYPARAMCOUNT	= 0x0200	/*		 _DWORD* 		 param,   bytesize = byte size to receive IDs	  */
	...
	,DCAM_IDMSG_QUERYPARAMID 	= 0x0204	/*		 _DWORD			 param[], bytesize = sizeof( param );	  */
