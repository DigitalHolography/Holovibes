...
typedef ViUInt32 ViAttrState;
    ...
    ViStatus _VI_FUNC viParseRsrc(ViSession rmSesn, ViConstRsrc rsrcName, ViPUInt16 intfType, ViPUInt16 intfNum);
    ...
    ViStatus _VI_FUNC viOpen(ViSession sesn, ViConstRsrc name, ViAccessMode mode, ViUInt32 timeout, ViPSession vi);
    ...
    ViStatus _VI_FUNC viLock(
        ViSession vi, ViAccessMode lockType, ViUInt32 timeout, ViConstKeyId requestedKey, ViChar _VI_FAR accessKey[]);
    ...
    ViStatus _VI_FUNC viWaitOnEvent(
        ViSession vi, ViEventType inEventType, ViUInt32 timeout, ViPEventType outEventType, ViPEvent outContext);
    ...
    ViStatus _VI_FUNC viVSPrintf(ViSession vi, ViBuf buf, ViConstString writeFmt, ViVAList parms);
    ...
    ViStatus _VI_FUNC viVSScanf(ViSession vi, ViConstBuf buf, ViConstString readFmt, ViVAList parms);

    ViStatus _VI_FUNCC viQueryf(ViSession vi, ViConstString writeFmt, ViConstString readFmt, ...);
    ViStatus _VI_FUNC viVQueryf(ViSession vi, ViConstString writeFmt, ViConstString readFmt, ViVAList params);
...
#if defined(_VI_INT64_UINT64_DEFINED)
    ViStatus _VI_FUNC viIn64(ViSession vi, ViUInt16 space, ViBusAddress offset, ViPUInt64 val64);
    ViStatus _VI_FUNC viOut64(ViSession vi, ViUInt16 space, ViBusAddress offset, ViUInt64 val64);

    ViStatus _VI_FUNC viIn8Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViPUInt8 val8);
    ViStatus _VI_FUNC viOut8Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViUInt8 val8);
    ViStatus _VI_FUNC viIn16Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViPUInt16 val16);
    ViStatus _VI_FUNC viOut16Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViUInt16 val16);
    ViStatus _VI_FUNC viIn32Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViPUInt32 val32);
    ViStatus _VI_FUNC viOut32Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViUInt32 val32);
    ViStatus _VI_FUNC viIn64Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViPUInt64 val64);
    ViStatus _VI_FUNC viOut64Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViUInt64 val64);
#endif
...
#if defined(_VI_INT64_UINT64_DEFINED)
    ViStatus _VI_FUNC viMoveIn64(ViSession vi, ViUInt16 space, ViBusAddress offset, ViBusSize length, ViAUInt64 buf64);
    ViStatus _VI_FUNC viMoveOut64(ViSession vi, ViUInt16 space, ViBusAddress offset, ViBusSize length, ViAUInt64 buf64);

    ViStatus _VI_FUNC viMoveIn8Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViBusSize length, ViAUInt8 buf8);
    ViStatus _VI_FUNC
    ...
    ViStatus _VI_FUNC
    viMoveIn64Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViBusSize length, ViAUInt64 buf64);
    ViStatus _VI_FUNC
    viMoveOut64Ex(ViSession vi, ViUInt16 space, ViBusAddress64 offset, ViBusSize length, ViAUInt64 buf64);
#endif
...
#if defined(_VI_INT64_UINT64_DEFINED)
    ViStatus _VI_FUNC viMoveEx(ViSession vi,
                               ViUInt16 srcSpace,
                               ...
                               ViUInt16 destWidth,
                               ViBusSize srcLength);
    ViStatus _VI_FUNC viMoveAsyncEx(ViSession vi,
                                    ViUInt16 srcSpace,
                                    ViBusAddress64 srcOffset,
                                    ViUInt16 srcWidth,
                                    ViUInt16 destSpace,
...
#if defined(_VI_INT64_UINT64_DEFINED)
    ViStatus _VI_FUNC viMapAddressEx(ViSession vi,
                                     ViUInt16 mapSpace,
...
#define viPeek8(vi, addr, val)                                                                                         \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            do                                                                                                         \
                (*((ViPUInt8)(val)) = *((volatile ViUInt8 _VI_PTR)(addr)));                                            \
...
#define viPoke8(vi, addr, val)                                                                                         \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            do                                                                                                         \
                (*((volatile ViUInt8 _VI_PTR)(addr)) = ((ViUInt8)(val)));                                              \
            while (**((volatile ViUInt8 _VI_PTR _VI_PTR)(vi)) & 0x10);                                                 \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
...
#define viPeek16(vi, addr, val)                                                                                        \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            do                                                                                                         \
                (*((ViPUInt16)(val)) = *((volatile ViUInt16 _VI_PTR)(addr)));                                          \
            while (**((volatile ViUInt8 _VI_PTR _VI_PTR)(vi)) & 0x10);                                                 \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
...
#define viPoke16(vi, addr, val)                                                                                        \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            do                                                                                                         \
                (*((volatile ViUInt16 _VI_PTR)(addr)) = ((ViUInt16)(val)));                                            \
            while (**((volatile ViUInt8 _VI_PTR _VI_PTR)(vi)) & 0x10);                                                 \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
...
#define viPeek32(vi, addr, val)                                                                                        \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            do                                                                                                         \
                (*((ViPUInt32)(val)) = *((volatile ViUInt32 _VI_PTR)(addr)));                                          \
            while (**((volatile ViUInt8 _VI_PTR _VI_PTR)(vi)) & 0x10);                                                 \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
...
#define viPoke32(vi, addr, val)                                                                                        \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            do                                                                                                         \
                (*((volatile ViUInt32 _VI_PTR)(addr)) = ((ViUInt32)(val)));                                            \
            while (**((volatile ViUInt8 _VI_PTR _VI_PTR)(vi)) & 0x10);                                                 \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
